# Skin Estuary MOD V2 for KODI 21 Omega: Skynet Edition
...
=======
This is a spinoff of Estuary Mod V2 skin (full details still found below). The goal behind this spinoff version was to focus on adding independent skin settings color customization in as many places as possible. More things to come...this is a very new project that was just done in a few days in late May 2026.
>>>>>>> 4e42a391ddc0304dcec218612a19a4be85833dd7
...
https://github.com/b-jesch/skin.estuary.skynet/tree/Omega (green Code button), **rename the root folder inside the ZIP**
from `skin.estuary.skynet-Omega` to `skin.estuary.skynet` and choose 'install from zip' inside Kodi. **Renaming
...
the management of those artwork. Animated artwork has some limitations (see Kodi Wiki: https://kodi.wiki/view/Artwork\_types#Animated\_Artwork).
...
* .1
  ...
  * Rotten Tomatoes categories updated (rottentomatoes, rottentomatoes\_topcritics, rottentomatoes\_audience),
...
* .19
  ...
  * Visibility condition of 1142\_themes changed (was always initialized before)
...
!\[PVR Info](resources/screenshots/screenshot\_1.png)!\[Embuary Info](resources/screenshots/screenshot\_2.png)
!\[Music Visualization](resources/screenshots/screenshot\_3.png)!\[PVR OSD](resources/screenshots/screenshot\_4.png)
!\[TV Widget](resources/screenshots/screenshot\_5.png)!\[Video OSD](resources/screenshots/screenshot\_6.png)
!\[Embuary localized Infos](resources/screenshots/screenshot\_7.png)
!\[New channel View](resources/screenshots/screenshot\_8.png)
!\[Improved OSD](resources/screenshots/screenshot\_9.png)
!\[simplified OSD](resources/screenshots/screenshot\_10.png)
!\[colored flags](resources/screenshots/screenshot\_11.png)
!\[improved nextup info](resources/screenshots/screenshot\_12.png)
!\[improved PVR event icons](resources/screenshots/screenshot\_13.png)
!\[various color...](resources/screenshots/screenshot\_14.png)
!\[...and font schemes](resources/screenshots/screenshot\_15.png)
!\[Audio DSP](resources/screenshots/screenshot\_16.png)
!\[Flix Landscape](resources/screenshots/screenshot\_17.png)
